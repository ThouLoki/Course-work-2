...
namespace Stepovyi_IS_51_Neruhomist
{
    public partial class ClientList : Form
    {
        ...
        {
            adap = new OleDbDataAdapter(@"SELECT * FROM Clients",
        ...
        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            ...
            System.IO.StreamWriter file = new System.IO.StreamWriter(".\\outputClients.txt");
            file.WriteLine(writer.ToString());
            file.Close();
            toolStripStatusLabel1.Text = "Зберігаю до \"outputClients.txt\", рекомендується відкрити файл в браузері...";
        }
